...
At the beginning of each Combat Round, each player makes an [Initiative](Skills.md#Initiative) skill check.  Any character's whose result is equal to or higher than the NPC group's Initiative score may act in either the Fast or Slow phase.  Those who roll lower always act in the Slow phase.  Within each group, the players decide amongst themselves the order in which they act, allowing them to plan and coordinate.  However, once one PC starts acting, they must finish all their actions before moving on to the next character.  No one's actions may be split up across multiple character activations.  The same rule applies to the order of NPC activations during the NPC phase.
