...
| d20   | Reaction    |
|:-----:|:------------|
| 1-    | **Hostile:** Will either attack or otherwise attempt to thwart the PCs.  If hostile action is not possible or is obvious suicide, will attempt to flee or get help. |
| 2-5   | **Unfriendly:** Will either attack or otherwise thwart the PCs if the NPCs have the upper hand. Otherwise will watch the PCs warily to see what they do. |
| 6-15  | **Neutral:** The NPCs are undecided and will keep a watch on what the PCs do before deciding on their own course of action. |
| 16-19 | **Indifferent:** Open to friendly negotiation or simply going about one another’s business unmolested. |
...
At the beginning of each Combat Round, each player makes an [Initiative](Skills.md#Initiative) skill check.  Any character's whose result is equal to or higher than the NPC group's Initiative score may act in the Fast phase.  Those who roll lower always act in the Slow phase.  Within each group, the players decide amongst themselves the order in which they act, allowing them to plan and coordinate.  However, once one PC starts acting, they must finish all their actions before moving on to the next character.  No one's actions may be split up across multiple character activations.  The same rule applies to the order of NPC activations during the NPC phase.  Finally, a character acting in the Fast phase may choose to delay their action and act as part of the Slow phase instead.

### Combat
Each character has a Movement Action and a Main Action that they may use each turn.  They might also have a Reaction that can be used in response to certain triggers.  A character's Movement Action may be split, using some prior to their Main Action and some after.  Some abilities also allow a character to use portions of their movement during their Main action (such as the Fighter's [Cleave](Knacks.md#Cleave) knack).

Opponents outside the reach of any opponents may move freely, but they are within reach of a foe, they are “engaged” and must abide by the rules under Defensive Movement, below.  Most creatures have a reach of 5', but some weapons and monster abilities grant longer reach.

### Running
Characters may choose to run; a running character is not normally allowed to attack (but see Charging, below). Running characters can move at double their normal encounter movement rate.
...
Characters, creatures, and vehicles of various sorts have a turning distance. This is given as a distance in feet in parentheses after their movement rate, and it determines how far they must move between free facing changes when moving about in combat.
...
- Also, most creatures can shift 5 feet laterally while preserving their facing (this is called “sidestepping”) for each increment of their turning distance, but this may only be done when moving at normal (“walking”) speed, not at fast (“running”) speed.
...
A winged flier can gain up to 10' of altitude after moving forward by the distance shown for its turning distance, and can dive (lose altitude in a controlled fashion) at up to twice the normal movement rate; if the creature does not move horizontally by at least one-third its normal speed, it will stall, being forced to dive at maximum rate for one round. Floating creatures or vehicles (balloons, fly spell, flying carpets, etc.) can climb vertically without horizontal motion up to half the normal movement rate, but such “floaters” can only descend at the normal movement rate, unless they have lost the ability to float entirely.  Incorporeal fliers/swimmers may gain altitude freely at their normal movement rate and lose altitude at their normal movement rate (they do not gain double movement from gravity like corporeal creatures).
