...
- **D:** Roll to determine the number of affected hit dice as for a 'T' result (above). However, instead of becoming Frightened, any undead creatures are permanently destroyed. Extra-planar unholy creatures (such as fiends) are banished back to their home plane for a minimum of 1 year per level of the Paladin. Unholy living creatures native to the plane the they are currently on that are affected each take 1d6 Holy damage per 2 full *caster levels* of the Paladin.
