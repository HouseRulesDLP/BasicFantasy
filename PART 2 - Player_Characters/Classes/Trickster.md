...
<li><strong>Starting Hit Points:</strong> 5 + Constitution Modifier</li>
<li><strong>Hit Dice (levels 2 to 10):</strong> 1d5 + Constitution Modifier</li>
<li><strong>Hit Points After Level 10:</strong> +1 per Level</li>
<li><strong>Armor Training:</strong> Light</li>
...
<table>
    <thead>
        <tr>
            ...
            <th colspan="5">Sorcerer Spells</th>
        </tr>
        <tr>
            <th>1$</th>
            <th>2</th>
