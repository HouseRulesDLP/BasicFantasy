...
**Intelligence:** This is the ability to learn and apply knowledge. Intelligence is a Prime Requisite for [Arcanists](Arcanist.md), [Tricksters](Trickster.md) and [Warlocks](Arcane_Warrior.md). The ability bonus for Intelligence is added to the number of [languages](#Languages) the character starts play with; if the character has an Intelligence penalty, he or she will always at least know his or her native language.
