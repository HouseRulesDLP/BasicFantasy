...
Hirelings (even mercenaries) will not follow their employer into a dungeon or other obviously suicidal endeavor.  They will trek through normal wilderness and mercenaries will guard the camp.

A PC cannot retain more hirelings than their **Charisma Score**.
...
Unlike Hirelings, an ally gains experience just as a PC does; however, as they are under the command of a PC and not acting on their own initiative, they only receive a half share of the experience.
...
### Alchemist
**Cost:** 35sp per day<br/>
These characters are generally hired for one of two reasons: to make potions, or to assist a spellcaster with magical research.

An alchemist can produce a potion, given the required materials and a sample or a written formula for the potion, in the same time and for the same cost as a spellcaster. They may also research new potions, but at twice the cost in time and materials as a spellcaster. Review the rules for Magical Research for details.

Alternately, a spellcaster seeking to create certain magic items may employ an alchemist as an assistant. In this case, the alchemist adds +3 to the spellcaster’s skill check.
...
Characters hiring mercenaries, or having armed and armored followers to take care of, will need the services of an armorer. In general, for every 50 warriors employed, one armorer is required to care for their gear. The armorer’s equipment is not included in the costs given above, but the cost to maintain his apprentices is included; most such characters will have 1d4 apprentices assisting.
...
### Engineer
**Cost:** 25sp per day<br/>
Any player character wishing to build a fortress, a ship, or any other mundane construction will need an engineer. Large projects may require several engineers, at the GM’s option.

### Sage
**Cost:** 50sp per day<br/>
Sages are experts in ancient and obscure knowledge. Many sages have particular interests in very limited or focused areas (for example, “Elven migrations of the 2nd age”), but even these will know or have access to a lot of facts. The listed cost is the minimum required to maintain a sage with his library, collections, etc. If the sage’s patron asks a difficult question, there may be additional costs for materials or research to answer it.

### Ship's Crew
**Cost:** special<br/>
A crew for a waterborne vessel involves several types of characters. At the very least, a complement of sailors and a Captain are needed; rowers will be needed aboard galleys, and a Navigator is required aboard ships going out of sight of land.

Costs per day for each sort of character are given below:

| Crew Type | Cost | Equipment (Cost) | Moral |
|:----------|-----:|:-----------------|:-----:|
| Captain   | 10sp | Scale Mail, M. Shield, Cutlass (340sp)                 | +5 |
| Marine    |  2sp | Ringmail, M. Shield, Spear, Light Melee Weapon (135sp) | +3 |
| Mate      |  7sp | Ringmail, M. Shield, Spear, Cutlass (145sp)            | +3 |
| Navigator |  7sp | None, Light Melee Weapon (10sp)                        | +0 |
| Rower     |  1cp | None, Buckler, Light Melee Weapon (20sp)               | +0 |
| Sailor    |  4cp | None, Buckler, Light Melee Weapon (20sp)               | +0 |
...
| Type of Mercenary        | Cost | Equipment (Cost)                                          | Morale |
|:-------------------------|-----:|:----------------------------------------------------------|:------:|
| Archer, Crossbow         | 14cp | Hardened Leather, L. Crossbow, Light Melee Weapon (125sp) | +3     |
| Archer, Longbow          | 27cp | Hardened Leather, Longbow, Light Melee Weapon (150sp)     | +3     |
| Archer, Mounted Shortbow |  4sp | Hardened Leather, Shortbow, Light Melee Weapon (250sp)    | +3     |
| Archer, Mounted Crossbow | 27cp | Hardened Leather, L. Crossbow, Light Melee Weapon (275sp) | +3     |
| Archer, Shortbow         | 14cp | Hardened Leather, Shortbow, Light Melee Weapon (100sp)    | +3     |
| Artillerist              | 34cp | Hardened Leather, Light Melee Weapon (50sp)               | +3     |
| Cavalry, Heavy           |  4sp | Chainmail, M. Shield, Lance, Arming Sword, LMW (2,680sp)  | +8     |
| Cavalry, Light           |  2sp | Hardened Leather, M. Shield, Lance, LMW (600sp)           | +3     |
| Cavalry, Medium          |  3sp | Scale Mail, M. Shield, Lance, Arming Sword, LMW (1,380sp) | +5     |
| Infantry, Heavy          | 14cp | Scale Mail, Pole Arm, Light Melee Weapon (350sp)          | +3     |
| Infantry, Heavy Mounted  |  2sp | Scale Mail, Pole Arm, Light Melee Weapon (500sp)          | +3     |
| Infantry, Light          |  7cp | Hardened Leather, M. Shield, Spear, LMW (75sp)            | +3     |
| Infantry, Light Mounted  | 14cp | Hardened Leather, M. Shield, Spear, LMW (225sp)           | +3     |
| Militia                  |  4cp | Improvised Weapon (10sp)                                  | +0     |
| Sapper                   |  3sp | Hardened Leather, Light Melee Weapon (50sp)               | +3     |
| Slinger                  |  2sp | Hardened Leather, Buckler, Sling, LMW (70sp)              | +3     |

Non-human mercenaries are typically 2 to 3 times the normal price for hire to employers not of their homeland.  They will also be equipped as befits their culture.