...
**Combat/Encounter Time** is measured in combat *Turns* (one creature’s chance to move and act), *Rounds* (the combined Turns of all participants; approximately 10 seconds) and *Minutes* (1 minute = 6 Rounds).

**Exploration Time** is measured in *Stretches* (approximately 10 minutes), *Hours* and *Watches* (4 Hours).
...
### Distance
Distances in the dungeon are measured in feet. Outdoors, several ranges are converted to yards (such as movement, bow ranges and so forth).  So, a bow with a 100ft range in the dungeon has a 100yd range outdoors.  Areas of effect are never converted in this fasion.
