...
- [[PART 1 - Introduction/Using the Dice|Using the Dice]]
	- [[PART 1 - Introduction/Using the Dice#Task Target Numbers|Task Target Numbers]]
	- [[PART 1 - Introduction/Using the Dice#Unusual Dice|Unusual Dice]]
	- [[PART 1 - Introduction/Using the Dice#Natural Result|Natural Result]]
	- [[PART 1 - Introduction/Using the Dice#Advantage and Disadvantage|Advantage and Disadvantage]]
	- [[PART 1 - Introduction/Using the Dice#Die Adjustments|Die Adjustments]]
- [[PART 1 - Introduction/Fortune|Fortune]]
- [[PART 1 - Introduction/Countdown Pools|Countdown Pools]]
    - [[PART 1 - Introduction/Countdown Pools#The Death Pool|The Death Pool]]
    - [[PART 1 - Introduction/Countdown Pools#Countdown Pool Average Number of Rolls|Average Number of Rolls]]
...
This iteration of these rules incorporates my own house rules to create a single reference for ease of use at my table.
