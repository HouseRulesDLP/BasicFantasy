...
- **Prime Requisite:** Dexterity 9+ and Charisma 11+
...
- **Armor Training:** Light & Medium Armor plus Bucklers
- **Weapon Training:** Small & Medium Weapons
...
*Typically the GM will roll Decipher Document, Lore and Perception checks in secret as the outcome of these tasks will not always be immediately obvious.*
...
**Hopeful Harmony:** When this song is first started and at the beginning of each round thereafter, the bard picks one of their allies who is within earshot. That ally adds the bard's Charisma modifier to any save vs *Fear* and NPC allies add the bard’s CHA modifier to their *Morale*.

**Lamenting Lyric:** All affected enemies within 30ft who can hear the bard subtracts the Bard's Charisma modifier from any *mental saving throws* they make until the start of the next round.

**Lullaby:** This tune affects up to 1 Hit Dice worth of creatures per level of the bard. Starting from the lowest HD creature and counting up, each must make a *Spell save* or fall *Unconscious*. Creatures rendered unconscious will stay unconscious for 3p4 rounds.  If an affected creature takes damage or someone attempts to physically wake it up, that creature may make a new saving throw at the end of that round.

**Masterful Music:** When this song is first started and at the beginning of each round thereafter, the bard picks one of their allies. That ally adds the bard's Charisma modifier to their Skill checks until the start of the bard's next turn.

**Horrifying Harmony:** This tune affects up to 1 Hit Dice worth of creatures per level of the bard. Starting from the lowest HD creature and counting up, each must make a *Spell save* or become *Frightened*. Creatures frightened in this way may repeat their save at the end of each round.

**Soothing Song:** When played during a *Short Rest*, everyone within earshot rolls an extra Hit Die for healing.

**Stealthy Sonnet:** While this song is played, all of the bard’s allies within 15 feet add the bard’s Charisma modifier to their *Stealth* checks.
...
<table>
	<thead>
		<tr>
			...
			<th align="center" rowspan="2"><b>Songs<br/>Known#</b></th>
		</tr>
		<tr>
	...
	<tbody>
		<tr>
			...
			<td align="center">+0</td><!--Blast-->
			<td align="center">+1</td><!--Spell-->
			<td align="center">13+</td><!--Save Target-->
			<td align="center">1</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">2</td><!--Level-->
			<td align="right">2,000</td><!--XP-->
			<td align="right">2d6</td><!--HD-->
		...
		<tr>
			...
			<td align="center">14+</td><!--Save Target-->
			<td align="center">2</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">4</td><!--Level-->
			<td align="right">8,000</td><!--XP-->
			<td align="right">4d6</td><!--HD-->
		...
		<tr>
			...
			<td align="center">15+</td><!--Save Target-->
			<td align="center">3</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">6</td><!--Level-->
			<td align="right">32,000</td><!--XP-->
			<td align="right">6d6</td><!--HD-->
		...
		<tr>
			...
			<td align="center">16+</td><!--Save Target-->
			<td align="center">4</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">8</td><!--Level-->
			<td align="right">120,000</td><!--XP-->
			<td align="right">8d6</td><!--HD-->
		...
		<tr>
			...
			<td align="center">17+</td><!--Save Target-->
			<td align="center">5</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">10</td><!--Level-->
			<td align="right">360,000</td><!--XP-->
			<td align="right">10d6</td><!--HD-->
		...
		<tr>
			...
			<td align="center">+7</td><!--Blast-->
			<td align="center">+9</td><!--Spell-->
			<td align="center">18+</td><!--Save Target-->
			<td align="center">6</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">12</td><!--Level-->
			<td align="right">600,000</td><!--XP-->
			<td align="right">10d6+4</td><!--HD-->
		...
		<tr>
			...
			<td align="center">19+</td><!--Save Target-->
			<td align="center">7</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">14</td><!--Level-->
			<td align="right">840,000</td><!--XP-->
			<td align="right">10d6+8</td><!--HD-->
		...
		<tr>
			...
			<td align="center">20+</td><!--Save Target-->
			<td align="center">8</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">16</td><!--Level-->
			<td align="right">1,080,000</td><!--XP-->
			<td align="right">10d6+12</td><!--HD-->
		...
		<tr>
			...
			<td align="center">+11</td><!--Blast-->
			<td align="center">+14</td><!--Spell-->
			<td align="center">21+</td><!--Save Target-->
			<td align="center">9</td><!--Songs Known-->
		</tr>
		<tr>
			<td align="center">18</td><!--Level-->
			<td align="right">1,320,000</td><!--XP-->
			<td align="right">10d6+16</td><!--HD-->
		...
		<tr>
			...
			<td align="center">22+</td><!--Save Target-->
			<td align="center">10</td><!--Songs Known-->
		</tr>
		<tr>
		...
		<tr>
			<td colspan=12>* Constitution modifiers no longer apply after level 10.<br/># Added the character's Charisma Modifier to the number of songs known.</td>
		</tr>
	</tbody>
</table>
